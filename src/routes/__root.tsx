...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Aurelian Construction Group" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Aurelian Construction Group" },
      { property: "og:title", content: "Aurelian Construction Group" },
      {
      ...
      { name: "twitter:site", content: "@aurelianbuilds" },
    ],
    links: [
      {
        rel: "stylesheet",
